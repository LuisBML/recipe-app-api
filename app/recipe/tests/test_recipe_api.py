...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@example', password='test.123')
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='other@example', password='other.123')
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        for ingredient in payload['ingredients']:
            item_exists = recipe.ingredients.filter(
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Tiramisu')
        recipe2 = create_recipe(user=self.user, title='Chicken Parmesan')
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Tiramisu')
        recipe2 = create_recipe(user=self.user, title='Chicken Parmesan')
        ing1 = Ingredient.objects.create(user=self.user, name='Espresso')
